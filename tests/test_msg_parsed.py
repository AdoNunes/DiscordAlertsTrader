...
class TestMessageParser(unittest.TestCase):
    ...
    def test_messages(self):
        ...
        'BTO AAPL 190C 07/21 @ 3 PT: 85%TS10% SL: 50%',
        'BTO TSLA 190C 07/21 @ 3 PT: 85%TS10% SL: 50%',
        'BTO TSLA 190C 07/21 @ 3 PT: 3.9TS10% SL: 50%',
        ...
        expect = [
            ...
            ('BTO AAPL 190C 07/21 3 , PT1:85%TS10%, PT2:None, PT3:None, SL:50%',
            ...
            ('BTO TSLA 190C 07/21 3 , PT1:85%TS10%, PT2:None, PT3:None, SL:50%',
            {'action': 'BTO', 'Symbol': 'TSLA_072123C190', 'Qty': 1, 'price': 3.0, 'asset': 'option',
            'strike': '190C', 'expDate': '07/21', 'risk': None, 'avg': None, 'PT1': '85%TS10%', 'PT2': None,
            'PT3': None, 'SL': '50%', 'n_PTs': 1, 'PTs_Qty': [1]}),
            ('BTO TSLA 190C 07/21 3 , PT1:3.9TS10%, PT2:None, PT3:None, SL:50%',
            {'action': 'BTO', 'Symbol': 'TSLA_072123C190', 'Qty': 1, 'price': 3.0, 'asset': 'option',
            ...
            ('BTO DPW 3.7 , PT1:3.72, PT2:None, PT3:None, SL:3.01',
            {'action': 'BTO', 'Symbol': 'DPW', 'Qty': 1, 'price': 3.7, 'asset': 'stock', 'risk': None,
            ...
            ('STC PNC 140c 07/21 1.4 ',
            {'action': 'STC', 'Symbol': 'PNC_072123C140', 'Qty': 1, 'price': 1.4, 'asset': 'option',
